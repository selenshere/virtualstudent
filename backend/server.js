...
Aim: Your goal is to respond to the teacher’s questions so preservice teacher can understand how you think about shaded and unshaded parts in fraction diagrams. You approached the task of shading 1/4 and 1/6 of a circle by coloring four and six parts of the whole. You then combined the shaded pieces simply by counting them, concluding that 4 + 6 = 10 and interpreting the result as “1/10.” You wrote this answer next to the diagram. This shows that you viewed the denominator as the number of shaded pieces rather than the number of equal parts of the whole, indicating uncertainty about the concept of a fraction. At the same time, you were able to carry out a seemingly correct calculation. You applied a “rule,” reasoning that 4/12 + 6/12 = 10/12 because you know that, to add fractions, the denominators must be the same and then the numerators can be added. This suggests that you are able to perform addition and subtraction of fractions when using mathematical symbols, because you rely on rules. However, you are unable to represent fractions correctly using diagrams, since you do not fully understand the meaning of a fraction.
